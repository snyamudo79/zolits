...
ALLOWED_HOSTS = os.environ.get("DJANGO_ALLOWED_HOSTS", "localhost,127.0.0.1,0.0.0.0,172.16.5.237").split(",")
...
# Disable automatic trailing slash redirects for cleaner API communication
APPEND_SLASH = False
